...
var webpack_isomorphic_tools = (function () {
	...
	webpack_isomorphic_tools.prototype.asset_source = function asset_source(asset_path) {
		...
		function possible_webpack_paths(asset_path) {
			...
			function construct_guesses(parts) {
				...
				for (var _iterator4 = rest, _isArray4 = Array.isArray(_iterator4), _i4 = 0, _iterator4 = _isArray4 ? _iterator4 : _getIterator(_iterator4);;) {
					var _ref4;
		...
		for (var _iterator5 = possible_webpack_asset_paths, _isArray5 = Array.isArray(_iterator5), _i5 = 0, _iterator5 = _isArray5 ? _iterator5 : _getIterator(_iterator5);;) {
			var _ref5;
	...
	webpack_isomorphic_tools.prototype.undo = function undo() {
		...
		for (var _iterator6 = this.hooks, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : _getIterator(_iterator6);;) {
			var _ref6;
	...
	webpack_isomorphic_tools.prototype.excludes = function excludes(path, options) {
		...
		for (var _iterator7 = options.exclude, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _getIterator(_iterator7);;) {
			var _ref7;
	...
	webpack_isomorphic_tools.prototype.includes = function includes(path, options) {
		...
		for (var _iterator8 = options.include, _isArray8 = Array.isArray(_iterator8), _i8 = 0, _iterator8 = _isArray8 ? _iterator8 : _getIterator(_iterator8);;) {
			var _ref8;
