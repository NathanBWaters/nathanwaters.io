...
var _ReactNodeTypes = require('react/lib/ReactNodeTypes');

var _ReactNodeTypes2 = _interopRequireDefault(_ReactNodeTypes);
...
var React3CompositeComponentWrapper = function (_ReactCompositeCompon) {
  ...
  _createClass(React3CompositeComponentWrapper, [{
    ...
    value: function unmountComponent(safely) {
      _get(Object.getPrototypeOf(React3CompositeComponentWrapper.prototype), 'unmountComponent', this).call(this, safely);
    ...
    value: function mountComponent(transaction, nativeParent, nativeContainerInfo, context) {
      ...
      if (Component.prototype && Component.prototype.isReactComponent) {
        if (process.env.NODE_ENV !== 'production') {
          var previousOwner = _ReactCurrentOwner2.default.current;
          ...
          try {
            ...
            _ReactCurrentOwner2.default.current = previousOwner;
          }
        } else {
          inst = new Component(publicProps, publicContext, _ReactUpdateQueue2.default);
        }
      } else {
        var componentConstructor = Component;

        if (process.env.NODE_ENV !== 'production') {
          var _previousOwner = _ReactCurrentOwner2.default.current;

          // noinspection JSValidateTypes
          _ReactCurrentOwner2.default.current = this;
          try {
            inst = componentConstructor(publicProps, publicContext, _ReactUpdateQueue2.default);
          } finally {
            _ReactCurrentOwner2.default.current = _previousOwner;
          }
        } else {
          inst = componentConstructor(publicProps, publicContext, _ReactUpdateQueue2.default);
        }
        if (!inst || !inst.render) {
          ...
          if (process.env.NODE_ENV !== 'production') {
            ...
            (0, _invariant2.default)(inst === null || inst === false || _ReactElement2.default.isValidElement(inst));
          }
    ...
    key: 'performInitialMount',
    value: function performInitialMount(_renderedElement, nativeParent, nativeContainerInfo, transaction, context) {
      ...
      this._renderedNodeType = _ReactNodeTypes2.default.getType(renderedElement);
      this._renderedComponent = this._instantiateReactComponent(renderedElement);

      var markup = _ReactReconciler2.default.mountComponent(this._renderedComponent, transaction, nativeParent, nativeContainerInfo, this._processChildContext(context));
